...
<html>
    ...
    <body>
        ...
        // line 20
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("img/header.jpg"), "html", null, true);
        echo ")\">
...
<html>
    ...
    <body>
        <header class=\"site-header\" style=\"background-image: url({{ asset('img/header.jpg') }})\">
            <span class=\"site-title\">My Symfony Site</span>
        </header>
        <nav>
            <ul>
