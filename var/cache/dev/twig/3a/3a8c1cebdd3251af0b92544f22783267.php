...
/* index.html.twig */
class __TwigTemplate_835130dce5f3d4481cafe062ca67d149 extends Template
{
    private $source;
    private $macros = [];
    ...
    <img class=\"medog\" src=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("img/dog.jpg"), "html", null, true);
        echo "\" alt=\"dog\">
    <p>Lite info om mig!</p>
...
{% block body %}
    <h1>Välkommen!</h1>
    <img class=\"medog\" src=\"{{ asset('img/dog.jpg') }}\" alt=\"dog\">
    <p>Lite info om mig!</p>
    <p>Mitt namn är Karoline och förutom programmering gillar jag att dyka och resa. På senaste tiden har fridykning varit något jag ägnat mig åt.</p>
    <p>För att varva ner mellan pluggrundorna fördrar jag även att meditera och göra yoga.</p>
    <p>Hundar är klart mitt favoritdjur.</p>
